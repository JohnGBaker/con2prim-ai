...
// Set whether or not to use the entropy equation
#define USE_ENTROPY_EQUATION (1)
...
struct output_stats {
  int font_fixed,vel_limited,failure_checker,tau_fix_applied;
  long n_iter;
#if( USE_ENTROPY_EQUATION )
  int fails_2d,fails_1d,fails_1dee,fails_1dee2;
  int check_2d,check_1d,check_1dee,check_1dee2;
#endif
};
...
#else
                                                                     , CCTK_REAL *S_entropy_local, CCTK_REAL *S_star );
#endif
